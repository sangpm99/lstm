# Time Series Cross Validation and R-Squared (3h pass + 1h future)
import numpy as np
import pandas as pd
...
# Thiết lập dữ liệu 3h quá khứ (5 cột) và +1h tương lai (1 cột)
for i in range(length - 3):
    if (
        len(RF_KienGiang) >= i + 3 and
        len(RF_LeThuy) >= i + 4 and
...
# dataFrame.to_csv('compare1.csv', index=False)
